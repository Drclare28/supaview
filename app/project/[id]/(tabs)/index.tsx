...
import { Database, Users, HardDrive, ChevronRight, ShieldCheck, Globe } from 'lucide-react-native';
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <View style={styles.centered}>
          ...
          <TouchableOpacity onPress={() => router.replace('/platform/projects')} style={{ marginTop: 20 }}>
            <Text style={{ color: Colors.primary }}>Back to Projects</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
      ...
      <ScrollView style={styles.container}>
        <View style={styles.header}>
          <View style={styles.headerTop}>
            ...
            <TouchableOpacity onPress={() => router.replace('/platform/projects')}>
